...
class AddGuardScreen extends StatelessWidget {
  AddGuardScreen({super.key});
          ...
          children: [
            ...
            Obx(() {
              ...
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Select Society', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w700, color: const Color(0xFF263238))),
                    ...
                    Container(
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.business_rounded, color: Color(0xFF283593), size: 22),
            ...
            Container(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Icon(Icons.info_outline_rounded, color: Color(0xFF3949AB), size: 20),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '• One mobile number = One user\n• Guard can log in using OTP\n• Access limited to guard panel only',
                          style: GoogleFonts.poppins(
                            fontSize: 12,
            ...
            Obx(() => SizedBox(
              ...
              child: ElevatedButton(
                onPressed: controller.isLoading.value ? null : () => controller.addGuard(),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: const Color(0xFF283593), size: 22),
          counterText: '',
